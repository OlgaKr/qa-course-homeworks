...
test('should display correct total after adding two drinks', async ({ page }) => {
  await page.goto('https://coffee-cart.app/');
  await page.locator('[data-test="Cappuccino"]').click();
...
test('should fill and validate checkout form fields after adding an item to cart', async ({ page }) => {
  await page.goto('https://coffee-cart.app/');
  ...
  await expect(page.getByRole('textbox', { name: 'Name' })).toHaveValue('Olga');
  await expect(page.getByRole('textbox', { name: 'Email' })).toHaveValue('olga@test.com');
});


test('should successfully place order for Cappuccino and display purchase confirmation', async ({ page }) => {
  await page.goto('https://coffee-cart.app/');
  await page.locator('[data-test="Cappuccino"]').click();
  await page.locator('[data-test="checkout"]').click();
  await page.getByRole('textbox', { name: 'Name' }).fill('Olga');
...
test('should display Cappuccino in cart after adding it from menu', async ({ page }) => {
  await page.goto('https://coffee-cart.app/');
  await page.locator('[data-test="Cappuccino"]').click();
